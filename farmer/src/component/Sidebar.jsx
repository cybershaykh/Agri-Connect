      ...
      <main className="flex-1 p-6">
        ...
        {activeTab === "products" && (
          <div className="space-y-10 p-4">
            ...
            <div className="bg-white rounded-xl shadow-md p-8 max-w-3xl mx-auto space-y-6 border border-gray-200">
              <div>
                ...
                {[
                  {
                    ...
                    image:
                      "https://media.istockphoto.com/id/2199057244/photo/local-produce-plot-of-land.jpg?s=612x612&w=0&k=20&c=qoumHZER6K02lI0XkTPzIomGDfvYyIcLO6z8o64YoDE=",
                  },
                  {
                    ...
                    category: "Technology",
                    image:
                      "https://media.istockphoto.com/id/2160078318/photo/close-up-of-a-farmer-planting-a-lettuce-seedling-on-a-community-garden.webp?b=1&s=612x612&w=0&k=20&c=QU2Mi5VKuuzFH4CnvIBtfquldzNkT83pyY0fNHVY518=",
                  },
                  {
                    ...
                    image:
                      "https://media.istockphoto.com/id/958953510/photo/agricultural-worker-takes-care-of-his-estate.webp?a=1&b=1&s=612x612&w=0&k=20&c=3i-QnCLOi3iw9wLf_GIEBJvzA9dmxCWU3ghQ8c2tFWE=",
                  },
                  {
                    ...
                    image:
                      "https://plus.unsplash.com/premium_photo-1733266915738-25f252337522?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fFdhdGVyJTIwQ29uc2VydmF0aW9uJTIwVGVjaG5pcXVlc3xlbnwwfHwwfHx8MA%3D%3D",
                  },
                ].map((article, i) => (
                  <div
                    key={i}
                ...
                {[
                  {
                    ...
                    views: "2.3K",
                    thumbnail:
                      "https://media.istockphoto.com/id/108310732/photo/crop-irrigation.webp?a=1&b=1&s=612x612&w=0&k=20&c=SekGs_kz6fqGaSMB2oR-jAo0nCf5mfCOq3i_2PIgN6E=",
                  },
                  {
                    ...
                    views: "1.8K",
                    thumbnail:
                      "https://plus.unsplash.com/premium_photo-1747132588806-7d981c4b62fb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8U29pbCUyMEhlYWx0aCUyME1hbmFnZW1lbnR8ZW58MHx8MHx8fDA%3D",
                  },
                  {
                    ...
                    views: "3.1K",
                    thumbnail:
                      "https://images.unsplash.com/photo-1727099079513-952d40de9d78?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8R3JlZW5ob3VzZSUyMEZhcm1pbmclMjBCYXNpY3N8ZW58MHx8MHx8fDA%3D",
                  },
                  {
                    ...
                    views: "1.5K",
                    thumbnail:
                      "https://plus.unsplash.com/premium_photo-1682129096859-3be46dd0f2dc?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8TGl2ZXN0b2NrJTIwQ2FyZSUyMEJlc3QlMjBQcmFjdGljZXN8ZW58MHx8MHx8fDA%3D",
                  },
                  {
                    ...
                    views: "2.7K",
                    thumbnail:
                      "https://media.istockphoto.com/id/91210277/photo/texture-from-green-grass.webp?a=1&b=1&s=612x612&w=0&k=20&c=eZtAv8jeME8VqD9_zniN0JNxd_PY7ll9jpMp0gDXgVo=",
                  },
                  {
                    ...
                    views: "1.9K",
                    thumbnail:
                      "https://images.unsplash.com/photo-1632850883408-dd47e3d435c7?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fEZhcm0lMjBFcXVpcG1lbnQlMjBNYWludGVuYW5jZXxlbnwwfHwwfHx8MA%3D%3D",
                  },
                ].map((video, i) => (
                  <div
                    key={i}
        ...
        {activeTab === "weather" && (
          <div className="space-y-6 px-4 md:px-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Weather information for your farm location
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="p-6 rounded-xl border shadow-sm bg-white">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Springfield, IL - Updated 10 minutes ago
                </p>
                ...
                <div className="space-y-4">
                  <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <p className="text-sm text-yellow-700">
                      Temperatures may drop below 32°F tonight. Protect
                      sensitive crops.
                    </p>
                  </div>
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <p className="text-sm text-blue-700">
                      Low rainfall expected. Consider watering crops in the next
                      2 days.
                    </p>
                  </div>
                  <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <p className="text-sm text-green-700">
                      Weather conditions are ideal for planting winter crops
                      this week.
                    </p>
                  </div>
                </div>
